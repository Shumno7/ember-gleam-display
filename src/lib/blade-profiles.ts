...
export const BLADE_PROFILES: Record<BladeKey, BladeProfile> = {
  ...
  longsword: {
    ...
    name:
      "font-monument font-semibold uppercase leading-[0.95] tracking-[0.12em] text-[clamp(1.9rem,7vw,3rem)] text-gold-bright",
    tagline:
  ...
  sabre: {
    ...
    vars: {
      "--plate-ratio": "1 / 1",
      "--edge-width": "2px",
      "--edge-radius": "12px 12px 12px 64px",
      "--edge-clip": "none",
      "--face-radius": "10px 10px 10px 62px",
      "--face-clip": "none",
      "--slot-inset": "16px",
      "--slot-radius": "8px 8px 8px 52px",
      "--slot-clip": "none",
      "--slot-mark": "0.12",
    } as CSSProperties,
    name:
  ...
  smallsword: {
    ...
    detailClass:
      "font-label font-light uppercase tracking-[0.28em] text-[0.56rem] text-gold-bright/75",
    ruleClass:
